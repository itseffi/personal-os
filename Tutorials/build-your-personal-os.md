...
A hands-on guide to building your own AI-powered productivity system using coding agents like Codex, Claude Code, Cursor, or Factory.
...
├── Resources/          # Voice samples, writing examples
...
- An AI coding agent: Codex, [Cursor](https://cursor.sh), [Claude Code](https://claude.ai), or [Factory](https://factory.ai)
...
- write SDK integration patterns doc
...
| Capability | .agents/skills/*/SKILL.md | Specialized workflows |
...
```
Workflows/
├── daily-standup.md       # Daily planning routine
├── backlog-processing.md  # Process raw captures
...
|---------|---------------|
| "What should I work on?" | Workflows/daily-standup.md |
| "Process my backlog" | Workflows/backlog-processing.md |
```
...
Create `Resources/voice-samples/` and add 5-10 examples of your actual writing:
- Emails you sent
- Posts you published
- Messages you liked
...
> "Read my voice samples in Resources/voice-samples/ and create a voice guide that captures my writing style. Save it to Knowledge/voice-guide.md"
