...
```
Read all files in Resources/voice-samples/ and analyze my writing style.
...
2. Read a sample from Resources/voice-samples/ if unsure
...
Use my voice - check Resources/voice-samples/ for reference.
```
...
```
You: Help me write a technical guide about our Q1 learnings

Claude (coordinator):
├── Subagent 1: Read Resources/voice-samples/ and extract style patterns
...
```
I need to write a technical guide about our Q1 learnings.

Before writing:
1. Read my voice samples in Resources/voice-samples/
...
### For reference:
See Resources/voice-samples/ for examples of my actual writing.
```
