...
Review Claude Code sessions to improve your workflows and AGENTS.md.

## Why Evals Matter

Every session with Claude is a learning opportunity:
...
- You learned something about working with Claude
...
4. Update skills in `Skills/` if relevant
...
## User Intent
Combine best parts of 4 folders into one personal-OS that works with Claude Code.
